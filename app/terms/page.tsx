...
export const metadata: Metadata = {
  title: "Terms of Service — BaileySystemsAI",
  description: "Terms of Service for BaileySystemsAI",
};

const SECTIONS = [
  {
    heading: "1. Service Description",
    body: `BaileySystemsAI provides a subscription-based SaaS platform that enables users to generate AI-powered websites, run lead-generation searches, and produce social media content ("the Service"). Access to specific features depends on the subscription plan you select.`,
  },
  {
    heading: "2. Subscription and Billing",
    body: `By subscribing, you authorize BaileySystemsAI to charge your payment method on a recurring monthly basis at the rate disclosed at checkout. All subscriptions begin with a 7-day free trial (one trial per email address). After the trial period your card is charged automatically. Prices may change with 30 days' notice to the email on file.`,
  },
  {
    heading: "3. Cancellation Policy",
    body: `You may cancel your subscription at any time from your billing dashboard or by emailing support@baileysystemsai.com. Cancellations take effect at the end of the current billing period — you retain access to paid features until that date. Cancelling before the trial ends means you will not be charged.`,
  },
  {
  ...
  },
  {
    ...
    body: `You agree not to use the Service to generate spam, harass individuals, violate any applicable law, attempt to reverse-engineer or scrape the platform, or create content that infringes third-party intellectual property rights. BaileySystemsAI reserves the right to suspend accounts that violate this policy without refund.`,
  },
  {
    heading: "6. Service Availability",
    body: `We strive for high availability but do not guarantee uninterrupted access. Scheduled maintenance, third-party outages (AI providers, payment processors, hosting), or unforeseen technical issues may cause temporary downtime. BaileySystemsAI is not liable for losses resulting from service interruptions.`,
  },
  {
    heading: "7. Intellectual Property",
    body: `Content you generate using the Service (website copy, social media posts, etc.) belongs to you. BaileySystemsAI retains ownership of the platform, codebase, prompts, and all underlying technology. You may not resell or sublicense access to the Service itself.`,
  },
  {
    heading: "8. Limitation of Liability",
    body: `To the maximum extent permitted by law, BaileySystemsAI's total liability to you for any claim arising under these Terms shall not exceed the amount you paid in the 30 days preceding the claim. We are not liable for indirect, incidental, special, or consequential damages of any kind, including lost profits or data.`,
  },
  {
  ...
  },
  {
    ...
    body: `Questions about these Terms? Reach us at support@baileysystemsai.com. We typically respond within 1–2 business days.`,
  },
];
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="mb-12">
          ...
          <p className="mt-4 text-[#6b7280] leading-relaxed">
            Please read these Terms of Service carefully before using BaileySystemsAI. By accessing or using our platform you agree to be bound by these Terms.
          </p>
        </div>
