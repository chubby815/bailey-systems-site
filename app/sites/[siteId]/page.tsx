...
// ── Industry hero photo map (Picsum IDs) ──────────────────────────────────────
...
export default async function SitePage({
  ...
  // ── Hero background style per heroStyle choice ────────────────────────────
  function heroBackground(): React.CSSProperties {
    ...
    if (heroStyle === "Gradient Background") {
      return {
        background: `linear-gradient(135deg, ${accent} 0%, ${accent}cc 40%, #0a0a1a 100%)`,
      };
    }
    // Solid Color
    ...
    <div style={{ fontFamily: font.body, color: "#1a1a1a", background: "#ffffff" }}>
      ...
      {siteIsPaused && (
        <div style={{
          ...
          backdropFilter: "blur(10px)", background: "rgba(0,0,0,0.82)",
          ...
          <div style={{
            ...
            <a href="/pricing" style={{
              ...
              fontWeight: 700, fontSize: "0.95rem", padding: "0.875rem 2.5rem",
      ...
      <nav style={{
        ...
        borderBottom: "1px solid #e5e7eb", padding: "0 1.5rem",
      }}>
      ...
      <section id="home" style={{
        ...
        {/* Overlay — always shown for text readability */}
        <div style={{
          position: "absolute", inset: 0, pointerEvents: "none",
          background: heroStyle === "Photo Background"
        ...
        <div style={{ position: "relative", maxWidth: "800px", margin: "0 auto" }}>
          <div style={{
            ...
            backdropFilter: "blur(8px)", borderRadius: "100px", padding: "6px 14px",
          ...
          <h1 style={{
            ...
            fontWeight: font.weight, lineHeight: 1.05,
            letterSpacing: "-0.03em", color: "#ffffff",
            marginBottom: "1.5rem", textShadow: "0 2px 20px rgba(0,0,0,0.4)",
          }}>
            {c.hero_headline}
          </h1>
          ...
          <p style={{
            ...
            lineHeight: 1.7, textShadow: "0 1px 8px rgba(0,0,0,0.3)",
          }}>
            {c.hero_subheadline}
          </p>
          ...
          <div style={{ display: "flex", gap: "1rem", justifyContent: "center", flexWrap: "wrap" }}>
            <a href="#contact" style={{
              background: accent, color: "#fff", fontWeight: 700,
              fontSize: "1rem", padding: "0.875rem 2rem", borderRadius: "10px",
              textDecoration: "none", boxShadow: `0 8px 24px ${accentMid}`,
            }}>
              {c.cta_text}
            </a>
      ...
      <section id="services" style={{ padding: "6rem 1.5rem", background: "#f9fafb" }}>
        <div style={{ maxWidth, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: "3.5rem" }}>
            ...
            <h2 style={{ fontFamily: font.heading, fontSize: "2.5rem", fontWeight: font.weight, letterSpacing: "-0.03em", color: "#111" }}>
              Our Services
            </h2>
          </div>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(240px, 1fr))", gap: "1.25rem" }}>
            {servicesList.map((service: string, i: number) => (
              <div key={i} style={{
                ...
                <h3 style={{ fontFamily: font.heading, fontSize: "1rem", fontWeight: 700, color: "#111", marginBottom: "0.5rem" }}>
                  {service}
                </h3>
      ...
      <section id="about" style={{ padding: "6rem 1.5rem", background: "#fff" }}>
        <div style={{ maxWidth, margin: "0 auto", display: "flex", gap: "4rem", alignItems: "center", flexWrap: "wrap" }}>
          ...
          <div style={{
            ...
            <div style={{ fontFamily: font.heading, fontSize: "2.5rem", fontWeight: font.weight, lineHeight: 1 }}>
          ...
          <div style={{ flex: 1, minWidth: "260px" }}>
            ...
            <h2 style={{ fontFamily: font.heading, fontSize: "2rem", fontWeight: font.weight, letterSpacing: "-0.03em", color: "#111", marginBottom: "1.25rem" }}>
              {userTagline || c.tagline}
            </h2>
      ...
      <section id="contact" style={{ padding: "6rem 1.5rem", background: "#f9fafb" }}>
        <div style={{ maxWidth: "600px", margin: "0 auto", textAlign: "center" }}>
          ...
          <h2 style={{ fontFamily: font.heading, fontSize: "2.25rem", fontWeight: font.weight, letterSpacing: "-0.03em", color: "#111", marginBottom: "1rem" }}>
            Ready to Get Started?
          </h2>
          <p style={{ color: "#6b7280", marginBottom: "2.5rem", lineHeight: 1.7 }}>
            Contact us today for a free estimate. We serve {serviceArea || `${location} and surrounding areas`}.
          </p>
          ...
          {businessHours && (
            <div style={{
              ...
              <div>
                <div style={{ fontWeight: 700, fontSize: "0.875rem", color: "#111", marginBottom: "0.25rem" }}>
                  Business Hours
                </div>
          ...
          <form style={{ display: "flex", flexDirection: "column", gap: "1rem", textAlign: "left" }}>
            ...
            <button type="button" style={{
              background: accent, color: "#fff", fontWeight: 700, fontSize: "1rem",
      ...
      <footer style={{ background: "#111", color: "#9ca3af", padding: "3rem 1.5rem" }}>
        <div style={{ maxWidth, margin: "0 auto" }}>
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", flexWrap: "wrap", gap: "2rem", marginBottom: "2rem" }}>
            {/* Brand */}
            <div>
              <div style={{ fontFamily: font.heading, fontWeight: font.weight, fontSize: "1.25rem", color: "#fff", marginBottom: "0.5rem", letterSpacing: "-0.03em" }}>
                {businessName}
              </div>
              <div style={{ fontSize: "0.875rem", color: "#6b7280", maxWidth: "260px", lineHeight: 1.6 }}>
                {userTagline || c.tagline}
              </div>
            </div>
            ...
            {hasSocialLinks && (
              <div style={{ display: "flex", flexDirection: "column", gap: "0.5rem" }}>
                <div style={{ fontSize: "0.75rem", fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.08em", color: "#4b5563", marginBottom: "0.5rem" }}>
                  Follow Us
                </div>
                {facebookUrl && (
                  <a href={facebookUrl} target="_blank" rel="noopener noreferrer"
                    style={{ fontSize: "0.875rem", color: "#9ca3af", textDecoration: "none", display: "flex", alignItems: "center", gap: "0.5rem" }}>
                    <span style={{ color: "#3b82f6" }}>f</span> Facebook
                  </a>
                )}
                {instagramUrl && (
                  <a href={instagramUrl} target="_blank" rel="noopener noreferrer"
                    style={{ fontSize: "0.875rem", color: "#9ca3af", textDecoration: "none", display: "flex", alignItems: "center", gap: "0.5rem" }}>
                    <span style={{ color: "#ec4899" }}>◎</span> Instagram
                  </a>
                )}
                {googleBusinessUrl && (
                  <a href={googleBusinessUrl} target="_blank" rel="noopener noreferrer"
                    style={{ fontSize: "0.875rem", color: "#9ca3af", textDecoration: "none", display: "flex", alignItems: "center", gap: "0.5rem" }}>
                    <span style={{ color: "#34d399" }}>G</span> Google Business
                  </a>
                )}
              </div>
            )}
