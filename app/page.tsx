...
export default function Home() {
  return (
    <div className="bg-[#08090a] text-[#f0f0f0] overflow-x-hidden">
      ...
      <section className="py-24 px-6 bg-[#0d0e10]">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="font-syne text-4xl md:text-5xl font-black tracking-tight">
              Live in 2 minutes flat
            </h2>
          </div>
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { n: "01", title: "Describe Your Business", desc: "Tell us your business name, industry, and what you offer. Takes less than 60 seconds." },
              { n: "02", title: "AI Builds Your Site", desc: "Our AI generates a full custom website with real images, copy, and your brand colors." },
              { n: "03", title: "Go Live Instantly", desc: "Your site is live on a custom subdomain. Share it, sell from it, grow with it." },
            ].map((step) => (
              <div key={step.n} className="text-center relative">
                <div className="w-16 h-16 rounded-full bg-[#08090a] border border-white/[0.07] flex items-center justify-center mx-auto mb-5">
      ...
      <section className="py-24 px-6">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-14">
            ...
            <p className="text-[#6b7280] mt-4 max-w-xl mx-auto">
              Every site below was generated by AI in under 2 minutes.
            </p>
          </div>
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              <a
                ...
                className="group bg-[#111214] border border-white/[0.07] hover:border-[#00e5a0]/30 rounded-2xl p-7 flex flex-col gap-4 transition-all hover:shadow-[0_0_30px_rgba(0,229,160,0.06)]"
              >
                <div className="text-4xl leading-none">{site.emoji}</div>
                <div className="flex-1">
                  <h3 className="font-syne font-bold text-lg mb-1 group-hover:text-[#00e5a0] transition-colors">
                    {site.name}
                  </h3>
                  <p className="text-xs text-[#4b5563]">{site.tag}</p>
                </div>
                <span className="text-sm font-semibold text-[#00e5a0] group-hover:text-[#00ffb2] transition-colors">
                  View Live →
                </span>
              </a>
            ))}
