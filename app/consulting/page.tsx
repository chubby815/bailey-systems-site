  ...
  return (
    <main className="min-h-screen bg-[#faf9f6] px-6 py-16 max-w-2xl mx-auto">
      <div className="border-4 border-black bg-white p-12 shadow-[12px_12px_0_#0a0a0a]">
        ...
        <p className="text-gray-600 mb-8 text-lg font-medium leading-relaxed" style={{ letterSpacing: '-0.01em' }}>
        ...
        {submitted ? (
          ...
          >
            ...
            <input type="hidden" name="_next" value={typeof window !== 'undefined' ? `${window.location.origin}/consulting?success=true` : 'https://bailey-systems-ai.vercel.app/consulting?success=true'} />

            <div>
              <label htmlFor="name" className="block text-sm font-bold text-black mb-2 uppercase tracking-wider" style={{ letterSpacing: '-0.01em' }}>
                Your Name
              </label>
              <input
                id="name"
            ...
            <div>
              <label htmlFor="email" className="block text-sm font-bold text-black mb-2 uppercase tracking-wider" style={{ letterSpacing: '-0.01em' }}>
                Email
              </label>
              <input
                id="email"
            ...
            <div>
              <label htmlFor="discount" className="block text-sm font-bold text-black mb-2 uppercase tracking-wider" style={{ letterSpacing: '-0.01em' }}>
            ...
            <div>
              <label htmlFor="message" className="block text-sm font-bold text-black mb-2 uppercase tracking-wider" style={{ letterSpacing: '-0.01em' }}>
                Project Details
              </label>
              <textarea
                id="message"
