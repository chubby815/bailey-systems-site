      ...
      <main className="min-h-screen bg-[#08090a] text-white">
        ...
        <div className="max-w-lg mx-auto px-6 py-16 text-center">
          ...
          <ul className="text-left space-y-2 max-w-sm mx-auto text-sm text-[#9ca3af] mb-8">
            <li className="flex items-center gap-2"><span className="text-[#00e5a0]">✓</span> Full sales scripts</li>
            <li className="flex items-center gap-2"><span className="text-[#00e5a0]">✓</span> Objection handlers</li>
            <li className="flex items-center gap-2"><span className="text-[#00e5a0]">✓</span> Power closing phrases</li>
          </ul>
          <Link
